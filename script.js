...
.then(function() {
  console.log("no 2 of asynk is resoled");
})

const promisesthree= new Promise(function(resolve,reject) {
setTimeout(function(){
console.log("async task three");
resolve({username:"sudhanshu singh",password:"sudh123",email:"sudhanshusingh@gmail.com"})
})
 },1000)
...
const promisefour= new Promise(function(resolve,reject){
  setTimeout(function(){
    let error=true
    if(!error){
      resolve({username:"kukusingh",password:"1234"})
    }
    else{
...
const promisefive= new Promise((resolve, reject) => {
  setTimeout(function(){
    let error=true
    if(!error){
      resolve({username:"its me billenare",useremail:"bilianre@gmail.com"})
    }
    else{
      reject("error sorry you are a bilanere")
    }
  },1000)
});
...
function createuser(username,score){
    ...
    tea.printme()
    chai.printme()
    let myhero=["thor","spiderman","superman"]
     let heropower={
        thor:"hamer",
        spiderman:"sling",
     ...
     Object.prototype.sudhanshu=function(){
        console.log(`sudhanshu is present in all object`);
    ...
    Array.prototype.heysudha=function(){
        console.log("hey sudhanshu singh");
    ...
    String.prototype.truelength=function(){
        console.log(`${this}`);
        console.log(`anotherusernam is :${this.trim().length}`);
    ...
    const chai = new user("chaiocode", "chai@123gmail.com", "123")
    ...
    user.prototype.chek=function(){
        return `${this.password}abc`
    }
    user.prototype.change=function(){
        return `${this.username.toUpperCase()}`
    }
     const chai=new user("sudhnashu","123")
     console.log(chai.chek());
    ...
    const sudhnshu= new user("sudh")
    console.log(sudhnshu.createId())
    
     const chai={
                name:"sudhanshu",
                usn:"99"
    }
      const discripter1=Object.getOwnPropertyDescriptor(chai,"name")
    // console.log(discripter1);
    
    Object.defineProperty(chai,"name",{
        writable: false,
        enumerable:false
    })
    const discripter=Object.getOwnPropertyDescriptor(chai,"name")
    ...
    const sudh = new user("sudhanshu@gmail.com", "abc")
    console.log(sudh.password);
